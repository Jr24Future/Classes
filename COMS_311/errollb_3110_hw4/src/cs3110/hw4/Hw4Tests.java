...
public class Hw4Tests {
    public static void main(String[] args) {
        ...
        CharacterSeparator.visualizeSeparations("test2.bmp");
    }

    public static void testWeightedGraphBasicOperations() {
        System.out.println("Testing Basic Graph Operations:");
        try {
    ...
    public static void testCharacterSeparatorSimpleImage() {
        ...
        try {
            String testImagePath = "test2.bmp";
            ...
            System.out.println("- Row separations sorted: " + 
                (isSorted(rowSeps) ? "PASS" : "FAIL"));
            System.out.println("- Column separations sorted: " + 
                (isSorted(colSeps) ? "PASS" : "FAIL"));
