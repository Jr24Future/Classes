...
public class CounterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* when increase btn is pressed, counter++, reset number textview (MODIFIED SO IT INCREASE PLUS 5 */
        ...
        /* when decrease btn is pressed, counter--, reset number textview  (MODIFIED SO THAT IT DECREASES BY 2*/
