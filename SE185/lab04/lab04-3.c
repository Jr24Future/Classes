...
#include <time.h>
#include <stdlib.h>    //add the library

/*---------------------------------------------------------------------------- -
-                                Prototypes                                   -         // fix the quotation
------------------------------------------------------------------------------*/
char ask_to_play(int times_played);

int select_random_number();

void run_game(int);    // add line
...
/*----------------------------------------------------------------------------
-								Implementation								 -         // fix the quotation
-----------------------------------------------------------------------------*/
int main(int argc, char *argv[])
{
    ...
    while (prompt == 'y')     /* This line does not contain an error */
    {
        ...
        prompt = ask_to_play(played);             //prompt = ask_to_play(playd);
    }
...
char ask_to_play(int played_before)
{
    ...
    if (!played_before)    /* This line does not contain an error */
    {
        ...
        scanf(" %c", &yes_or_no);  //scanf(" %c", yes_or_no); 
    } else
    {
        scanf(" %c", &yes_or_no);
    }
