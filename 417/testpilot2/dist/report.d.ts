...
export declare namespace TestOutcome {
    function PASSED(coverageReport?: string, coverageData?: string): TestOutcome;
    const PENDING: TestOutcome;
    const OTHER: TestOutcome;
    function FAILED(err: ITestFailureInfo): TestOutcome;
}
