...
export declare abstract class TestValidator {
    /** Validate the given test, determining whether it passes or not. */
    abstract validateTest(testName: string, testSource: string): TestOutcome;
    /** Compute a coverage summary for all passing tests this validator has seen. */
    abstract computeCoverageSummary(): ICoverageSummary;
