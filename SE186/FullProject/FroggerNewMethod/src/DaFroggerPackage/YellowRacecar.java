...
public class YellowRacecar extends Obby {


	public YellowRacecar(int FSM, int levelSpeed) {
		super(224*FSM, 208*FSM, 16*FSM, 16*FSM, FSM, -1, true, levelSpeed, 2);
	...
	private BufferedImage craftImage(int FSM) {
		...
		String s = this.getClass().getResource("/DaFroggerAssets/racecarLeft_16x16.png").toString();  //Make Sure to update this when importing assets
		s = s.substring(6);
