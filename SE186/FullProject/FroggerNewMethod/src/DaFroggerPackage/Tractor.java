...
public class Tractor extends Obby {

	public Tractor(int FSM, int levelSpeed) {
		super(-16*FSM, 192*FSM, 16*FSM, 16*FSM, FSM, 1, true, levelSpeed, 1);
	...
	private BufferedImage craftImage(int FSM) {
		...
		String s = this.getClass().getResource("/DaFroggerAssets/tractor_16x16.png").toString();  //Make Sure to update this when importing assets
		s = s.substring(6);
