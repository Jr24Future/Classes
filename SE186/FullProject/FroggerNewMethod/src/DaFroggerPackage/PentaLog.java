...
public class PentaLog extends Obby{
	public PentaLog(int FSM, int levelSpeed) {
		super(-80*FSM, 80*FSM, 80*FSM, 16*FSM, FSM, 1, false, levelSpeed, 3);
	...
	private BufferedImage craftImage(int FSM) {
		...
		image = new BufferedImage(80*FSM, 16*FSM, BufferedImage.TYPE_INT_ARGB);
		...
		g2.drawImage(imageToDraw, 48*FSM, 0, 32*FSM, 16*FSM, null);
		return image;
	}
}
