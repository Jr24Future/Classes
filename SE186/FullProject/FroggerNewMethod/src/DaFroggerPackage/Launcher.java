...
public class Launcher {
	...
	private static void play(List<Obby> list, Frog frog, Boolean[] frogCanMoveDirections) throws Exception {
		updateTimer();
		updateLives();
	...
	private static void hitReg(List<Obby>list, Frog frog, Boolean[] frogCanMoveDirections) throws Exception {
	...
	private static void death(List<Obby> list,  Frog frog, Boolean[] frogCanMoveDirections) throws Exception {
		livesRemaining-=1;
		if (livesRemaining < 1) {
			MF.frame.dispose();
			System.exit(0);
	...
	private static void resetLevel(List<Obby> list,  Frog frog, Boolean[] frogCanMoveDirections) throws Exception {
		stopped = true;
		timeRemaining = 30.0;
		lastLaneReached = 0;
	...
	*/
	...
	private static void makeScoreLabels() throws Exception {
