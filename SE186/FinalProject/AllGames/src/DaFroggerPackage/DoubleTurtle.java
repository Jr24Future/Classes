...
public class DoubleTurtle extends Obby{
	private Boolean flipper;
	private int animationState;
	public DoubleTurtle(int FSM, int levelSpeed, Boolean flipper) {
		super(224*FSM, 64*FSM, 32*FSM, 16*FSM, FSM, -1, false, levelSpeed, 2);
